section .data
    alfa times 6 db 0    ; Reserve 6 bytes (3 words) of memory, initialized to zero
...
_start:
    ...
    ; FIXED: Changed invalid instruction (can't move 32-bit to 16-bit)
    mov eax, ebx         ; EAX = EBX (pointer to alfa)
    ; Alternative fix: mov ax, bx    ; If you only need the lower 16 bits
    
    mov ax, cx           ; AX = original AX again
    xchg ax, bx          ; Swap AX and BX (BX is lower 16 bits of EBX)
